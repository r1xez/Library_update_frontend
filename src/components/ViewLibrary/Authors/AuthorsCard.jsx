...
const AuthorCard = ({ author, onDelete, onUpdate, canEdit = true }) => {
    ...
    const birthDate = author.birthDate ? new Date(author.birthDate).toLocaleDateString() : 'Unknown';
            ...
            <div className="glass-card author-card">
                ...
                {canEdit && (
                    <div className="card-actions">
                        <button className="btn-action edit" onClick={handleEditClick}>Edit</button>
                        <button className="btn-action delete" onClick={() => onDelete && onDelete(author.id)}>Delete</button>
                    </div>
                )}
            </div>
